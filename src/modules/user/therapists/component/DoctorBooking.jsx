  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-6 py-8">
        <div className="mb-6">
          <h2 className="text-2xl font-bold text-gray-800">Available Doctors ({filteredDoctors.length})</h2>
          ...
          {filteredDoctors.map(doctor => (
            <div key={doctor.id} className="bg-white rounded-xl shadow-sm border hover:shadow-md transition-shadow">
              <div className="p-6">
                ...
                <h3 className="text-lg font-semibold text-gray-800 text-center mb-1">{doctor.name}</h3>
                <p className="text-blue-600 text-center mb-3 font-medium">{doctor.specialty}</p>
                <p className="text-gray-600 text-sm text-center mb-4 leading-relaxed">{doctor.description}</p>
