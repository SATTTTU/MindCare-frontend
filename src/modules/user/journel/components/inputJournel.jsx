      ...
      <div className="flex-grow p-5 flex items-center justify-center">
        ...
        <div className="w-full max-w-2xl bg-white rounded-3xl shadow-2xl p-8 md:p-12 relative overflow-hidden">
          ...
          <div className="text-center mb-10 relative z-10">
            {/* The `animate-pulse-custom` class from your global CSS will be applied here */}
          ...
          {formik.status?.success && (
            // The `animate-float-in` class from your global CSS will be applied here
          ...
          <form onSubmit={formik.handleSubmit} className="relative z-10">
            <div className="relative mb-6">
              ...
              {/* Character Count */}
              <div className="absolute bottom-3 right-5 text-sm text-slate-400 font-medium bg-white bg-opacity-90 px-2 py-1 rounded-lg">
            ...
            >
              {formik.isSubmitting ? (
                <>
                  {/* The `animate-spin-custom` class will be applied here */}
